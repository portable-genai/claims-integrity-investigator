...
INCOMPLETE_MANAGED_OPERATIONS: tuple[str, ...] = (
    "claim_file.CloudClaimFileAdapter.fetch",
    "claims_history.CloudClaimsHistoryAdapter.history",
    "extraction.CloudExtractionAdapter.extract",
    "fraud_linkage.CloudFraudLinkageAdapter.linkage",
    "generation.CloudGenerationAdapter.generate",
    "policy_corpus.Hrz2PolicyCorpusAdapter.retrieve",
)
