...
distinct from this service's own inbound ``CLAIMSINTEG_S2S_TOKEN``.
...
_SERVICE_ACTOR = "claims-integrity-investigator"
...
class CloudReviewRouter:
    ...
    def route(self, result: ClaimAssessment, *, maker: str, tenant: str = "") -> str:
