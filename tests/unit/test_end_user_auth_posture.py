...
read
    ...
    bind_profile == local AND profile chosen AND CLAIMSINTEG_S2S_TOKEN unset
...
from claims_integrity_investigator.adapters.local.identity import (
    LocalIdentityAdapter,
)
from claims_integrity_investigator.adapters.onprem.identity import (
