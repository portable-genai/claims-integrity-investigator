# Claims Integrity Investigator (claims-integrity-investigator) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    CLAIMSINTEG_PROFILE=gcp \
    CLAIMSINTEG_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "python -m claims_integrity_investigator.managed_readiness && exec uvicorn claims_integrity_investigator.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
